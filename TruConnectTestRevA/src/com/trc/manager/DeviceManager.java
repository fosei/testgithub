...
public class DeviceManager implements DeviceManagerModel {
  ...
  public NetworkInfo swapDevice(User user, DeviceInfo oldDeviceInfo, DeviceInfo newDeviceInfo)
    ...
    try {
      clearDevicesFromCache();
				// DEBUG CODE
      			new DeviceManager().listNewSwapDeviceInfo(oldDeviceInfo.getDeviceId(),oldDeviceInfo.getDeviceValue(),oldDeviceInfo.getDeviceLabel());
      			new DeviceManager().listNewSwapDeviceInfo(newDeviceInfo.getDeviceId(),newDeviceInfo.getDeviceValue(),newDeviceInfo.getDeviceLabel());      
      NetworkInfo oldNetworkInfo = deviceService.getNetworkInfo(oldDeviceInfo.getDeviceValue(), null);
				// DEBUG CODE
				System.out.println("oldDeviceInfo [ deviceId :: "+oldDeviceInfo.getDeviceId()+", deviceValue :: "+oldDeviceInfo.getDeviceValue()+
				           	", deviceLabel :: "+oldDeviceInfo.getDeviceLabel());
				System.out.println("newDeviceInfo [ deviceId :: "+newDeviceInfo.getDeviceId()+", deviceValue :: "+newDeviceInfo.getDeviceValue()+
							", deviceLabel :: "+newDeviceInfo.getDeviceLabel());				      
	...
	// DEBUG CODE
	@Loggable(value = LogLevel.TRACE)
	public void listDeviceInfo(int deviceId, String esn, String deviceLabel){
		return;
	}
	
	// DEBUG CODE
	@Loggable(value = LogLevel.TRACE)
	public void listNewDeviceInfo(String esn, String deviceLabel){
		return;
	}
	
	// DEBUG CODE
	@Loggable(value = LogLevel.TRACE)
	public void listNewSwapDeviceInfo(int deviceId, String esn, String deviceLabel){
		return;
	}
