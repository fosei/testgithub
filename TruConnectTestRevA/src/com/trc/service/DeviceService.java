...
public class DeviceService implements DeviceServiceModel {
  ...
  public NetworkInfo swapDevice(User user, NetworkInfo oldNetworkInfo, DeviceInfo deviceInfo)
    ...
    try {
				// DEBUG CODE
				System.out.println("oldNetworkInfo [ Mdn :: "+oldNetworkInfo.getMdn()+", Msid :: "+oldNetworkInfo.getMsid()+
						   ", Esnmeiddec :: "+oldNetworkInfo.getEsnmeiddec()+", Esnmeidhex :: "+oldNetworkInfo.getEsnmeidhex()+
						   ", Status (int) :: "+oldNetworkInfo.getStatus());
				System.out.println("deviceInfo [ deviceId :: "+deviceInfo.getDeviceId()+", deviceValue :: "+deviceInfo.getDeviceValue()+
				           ", deviceLabel :: "+deviceInfo.getDeviceLabel());	    	
