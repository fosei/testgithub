  ...
  public ModelAndView postSwapDevice(@PathVariable String encodedDeviceId, @ModelAttribute DeviceInfo deviceInfo,
    ...
    try {
     ...
     // }
      			...
      			newDeviceInfo.setAccountNo(oldDeviceInfo.getAccountNo());
      			newDeviceInfo.setCustId(oldDeviceInfo.getCustId());
      			newDeviceInfo.setDeviceAssociation(oldDeviceInfo.getDeviceAssociation());
      			newDeviceInfo.setDeviceStatus(oldDeviceInfo.getDeviceStatus());
      			newDeviceInfo.setDeviceStatusId(oldDeviceInfo.getDeviceStatusId());
      			newDeviceInfo.setEffectiveDate(oldDeviceInfo.getEffectiveDate());
      			newDeviceInfo.setExpirationDate(oldDeviceInfo.getExpirationDate());
      			newDeviceInfo.setModDate(oldDeviceInfo.getModDate());
      
      			// DEBUG CODE
				deviceManager.listDeviceInfo(oldDeviceInfo.getDeviceId(),oldDeviceInfo.getDeviceValue(),oldDeviceInfo.getDeviceLabel());
				deviceManager.listNewDeviceInfo(newEsn,newDeviceLabel);
				deviceManager.listNewSwapDeviceInfo(newDeviceInfo.getDeviceId(),newDeviceInfo.getDeviceValue(),newDeviceInfo.getDeviceLabel());
